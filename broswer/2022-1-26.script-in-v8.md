...
![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0073.jpg)
...
![整体流程](../images/ppl/v8-all-process.png)

## 脚本解析

![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0005.jpg)
...
![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0011.jpg)

整体流程如下，脚本被解析后全量编译生成没有优化的Bytecode字节码

![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0013.jpg)


## 运行多次的脚本被优化

![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0012.jpg)

运行多次的代码会被再次编译，通过Crankshaft（旧）或者TurboFan然后生成优化后的代码加速下次执行的效率

![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0014.jpg)


## 问题是什么？

![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0015.jpg)

![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0016.jpg)

浏览器渲染进程的30%～50%的内存被V8堆占据，而从启动时间来看33%的时间会花费在Parse解析和Compile编译代码上


![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0017.jpg)
...
![](../images/ppl/uF9N7n.png)

有了如上的背景认识后应该可以理解为什么要这样做。

![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0022.jpg)
...
![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0024.jpg)
...
![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0026.jpg)
...
![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0032.jpg)
...
![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0033.jpg)

Lda是赋值，Smi是V8里小整数的名称，所以这里第一行字节码将100加载到累加器里，对应最右侧的红色100

![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0034.jpg)

a2原有150减去累加器的100，最后得到50。所以累加器在第二行字节码结束后被存入50结束。进入第三行字节码，对应结果赋值给变量d

![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0035.jpg)

所以这里Star是将累加器结果赋值给r0，r0为50，即源代码里d为50。继续第四行字节码

![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0036.jpg)

第四行Ldar加载参数b，赋值a1，就是2，此时累加器为2，r0为50

![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0037.jpg)

字节码第五行Mul为乘法，即执行2*50得到100存入累加器

![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0038.jpg)

第6行字节码，加上a0的值，可以看到a0为5，所以此处最后累加器为105。最后一行字节码返回，即返回此时的累加器的值，最后返回了105。

![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0039.jpg)



## Ignition Bytecode Pipeline

![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0041.jpg)

源代码被解析后生成AST，遍历AST节点后经过字节码生成器。代码如上图右边所示，首先访问左边表达式并存入寄存器，然后计算表达式的右侧（命名可以看出这里有累加器的参与），执行add操作后，将执行结果设置到累加器里。

![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0045.jpg)
...
![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0047.jpg)

上面处理后通过Bytecode Array Writer重新写入给到Interpreter解释器（即前面说的Ignition）。

![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0053.jpg)
...
![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0070.jpg)
...
![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0074.jpg)

TurboFan对Ignition处理源代码生成的Bytecode字节码处理后生成上图右侧的图一样的结构

![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0076.jpg)
...
![](../images/ignitionV8%2FIgnition_%20An%20Interpreter%20for%20V8%20%5BBlinkOn%5D_page-0077.jpg)
