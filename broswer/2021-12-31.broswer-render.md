...
![](/images/ppl/blink-layer-structure.png)

开源源代码和部分目录
下图每部分对应源代码链接：https://chromium.googlesource.com/chromium/src.git/+/refs/heads/main
![](/images/ppl/open-source-mapping.png)

### 浏览器多进程架构简单介绍

![](/images/ppl/BG4tvT7y95iPAelkeadP.png)
...
![](/images/Life_of_a_Pixel/5.png)


![](/images/Life_of_a_Pixel/6.png)
...
![](/images/Life_of_a_Pixel/11.png)


![](/images/Life_of_a_Pixel/12.png)
...
![](/images/Life_of_a_Pixel/13.png)


![](/images/Life_of_a_Pixel/14.png)
...
![](/images/Life_of_a_Pixel/19.png)


![](/images/Life_of_a_Pixel/20.png)
...
![](/images/Life_of_a_Pixel/38.png)


![](/images/Life_of_a_Pixel/39.png)
...
![](/images/Life_of_a_Pixel/48.png)

任务还可以对页面中嵌入的图像资源进行解码。绘制指令引用压缩数据(JPEG、PNG等)，任务调用适当的解码器将其解压缩。

### GPU加速栅格化

![](/images/Life_of_a_Pixel/49.png)
...
![](/images/Life_of_a_Pixel/60.png)


分层的作用在有动画时候可以显著提升性能，如图所示BBB文本一层的变换不会影响其他层

![](/images/Life_of_a_Pixel/l9Za8n.jpg)

类似皮影戏，背景元素大体不懂，动的是任务和道具，单独一层方便控制，也减少消耗

![](/images/Life_of_a_Pixel/61.png)



![](/images/Life_of_a_Pixel/compositing.gif)
...
![](/images/ppl/Fz3dTG.jpg)

### 根据分块tiles合成**CompositorFrame**

![](/images/Life_of_a_Pixel/73.png)
